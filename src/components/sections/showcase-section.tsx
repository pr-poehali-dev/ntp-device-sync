        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-start mb-20">
          ...
          >
            ...
            <div className="space-y-4 text-muted-foreground leading-relaxed">
              <p>
                Мой опыт работы в парикмахерском искусстве 30 лет. Свой профессиональный путь я начала ещё в 1996 году.
              </p>
              <p>
                Быть мастером волос — это создавать желанный образ, быть феей перевоплощения и дарить невероятные эмоции. Для меня всегда важен качественный результат и премиум сервис.
              </p>
              <p>
                В моей работе важна точность, аккуратность, индивидуальный подход к каждому клиенту. Специализируюсь на классических и современных техниках стрижки, уходе за волосами и женском/мужском моделировании образа.
              </p>
              <p>
                Моя главная цель — это долговременный результат, который будет сопровождать в повседневной жизни и в важные моменты.
              </p>
              <p className="font-medium text-foreground">
                С любовью, топ-мастер Москвы Ежова Алёна
              </p>
            </div>
            <motion.a
              href="#booking"
